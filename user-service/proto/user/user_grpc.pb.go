...
const (
	...
	UserService_GetBusinessId_FullMethodName = "/user.UserService/GetBusinessId"
)
...
type UserServiceClient interface {
	...
	GetBusinessId(ctx context.Context, in *GetBusinessIdRequest, opts ...grpc.CallOption) (*GetBusinessIdResponse, error)
}
...
func (c *userServiceClient) GetBusinessId(ctx context.Context, in *GetBusinessIdRequest, opts ...grpc.CallOption) (*GetBusinessIdResponse, error) {
	out := new(GetBusinessIdResponse)
	err := c.cc.Invoke(ctx, UserService_GetBusinessId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetBusinessId(context.Context, *GetBusinessIdRequest) (*GetBusinessIdResponse, error)
...
func (UnimplementedUserServiceServer) GetBusinessId(context.Context, *GetBusinessIdRequest) (*GetBusinessIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBusinessId not implemented")
}
...
func _UserService_GetBusinessId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBusinessIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetBusinessId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetBusinessId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetBusinessId(ctx, req.(*GetBusinessIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBusinessId",
			Handler:    _UserService_GetBusinessId_Handler,
		},
	},
